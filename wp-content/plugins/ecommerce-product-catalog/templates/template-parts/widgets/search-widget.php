...
if ( $instance !== false ) {
	...
	?>
	<form role="search" class="<?php echo apply_filters( 'ic_search_box_class', '', $instance ) ?>" method="get" id="product_search_form" action="<?php echo esc_url( home_url( '/' ) ) ?>">
		...
		<div class="ic-search-container">
			<input class="product-search-box" type="search" value="<?php echo get_search_query() ?>" name="s" placeholder="<?php echo $label ?>" />
