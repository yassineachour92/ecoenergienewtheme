	...
	function widget( $args, $instance ) {
		if ( get_integration_type() != 'simple' ) {
			...
			if ( $d ) {
				...
				$cat_args = array( 'orderby' => 'name', 'show_count' => $c, 'hierarchical' => $h, 'taxonomy' => $taxonomy, 'walker' => new ic_cat_Walker_CategoryDropdown, 'show_option_none' => $label );
				...
				<script type='text/javascript'>
				    ...
				    function onCatChange() {
				        if ( dropdown.options[dropdown.selectedIndex].value != '' ) {
				            location.href = "<?php echo home_url(); ?>/?<?php echo $taxonomy ?>=" + dropdown.options[dropdown.selectedIndex].value;
				        }
				    }
