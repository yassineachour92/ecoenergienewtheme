		...
		<?php if ( $submenu == 'support' ) { ?>
			<div class="setting-content submenu support-tab">
			  ...
			  <p><?php _e('If you found eCommerce Product Catalog useful or it saved you some amount of time please consider to support its development by buying premium support or an extension. This is better than a donation, because you get even more value with it. All the income from premium support and extensions goes for eCommerce Product Catalog and its extensions development. Everybody wins.','ecommerce-product-catalog'); ?></p> */ ?>
				...
				<p><strong><?php _e( 'Please consider upgrading to support the project.', 'ecommerce-product-catalog' ) ?></strong></p>
				<div style="clear: both; height: 10px;"></div>
				<div class="extension premium-support">
					<a href="https://implecode.com/wordpress/plugins/premium-support/#cam=catalog-support-tab&key=support-link"><h3><span><?php _e( 'Premium Toolset', 'ecommerce-product-catalog' ) ?></span></h3></a>
				...
				<ol>
					<li><?php _e( '<b>Alternative Products</b> - select alternative products for each individual product and display then in a separate tab or section', 'ecommerce-product-catalog' ) ?>;</li>
					<li><?php _e( '<b>Alternative Products Table</b> - display alternative products as a table with many different parameters to compare', 'ecommerce-product-catalog' ) ?>;</li>
					<li><?php _e( '<b>Price Filter Ranges</b> - set clickable price filter ranges in the price filter widget', 'ecommerce-product-catalog' ) ?>;</li>
					<li><?php _e( '<b>Category template</b> - select different template for categories', 'ecommerce-product-catalog' ) ?>;</li>
					<li><?php _e( '<b>Disabled default image</b> - disable default image for category pages', 'ecommerce-product-catalog' ) ?>;</li>
					<li><?php _e( '<b>Automatic Product Descriptions</b> - generate product descriptions from category descriptions', 'ecommerce-product-catalog' ) ?>;</li>
					<li><?php _e( '<b>Enhanced category filter</b> - only bottom category clickable or always show child categories', 'ecommerce-product-catalog' ) ?>;</li>
					<li><?php _e( '<b>Checkbox category filter</b> - checkbox instead of links for category filter', 'ecommerce-product-catalog' ) ?>;</li>
					<li><?php _e( '<b>Alternative listng template</b> - let the user switch the listing template on front-end - for example between grid or list.', 'ecommerce-product-catalog' ) ?>;</li>
					<li><?php _e( '<b>Product Count widget</b> - product count widget that shows the number of displayed products', 'ecommerce-product-catalog' ) ?>;</li>
					<li><?php _e( '<b>Product Pagination widget</b> - display pagination in any widget area', 'ecommerce-product-catalog' ) ?>;</li>
					<li><?php _e( '<b>Product Promo widget</b> - display selected or random product in widget area', 'ecommerce-product-catalog' ) ?>;</li>
					<li><?php _e( '<b>Product tags</b> - which is considered as SEO booster if used properly', 'ecommerce-product-catalog' ) ?>;</li>
					<li><?php _e( '<b>Product tags filter</b> - filter products by tags', 'ecommerce-product-catalog' ) ?>;</li>
					<li><?php _e( '<b>Separate sidebar</b> on main listing, individual product, catalog search and category pages', 'ecommerce-product-catalog' ) ?>;</li>
					<li><?php _e( '<b>Responsive sidebar</b> - select styling and appearance for sidebar on small screens', 'ecommerce-product-catalog' ) ?>;</li>
